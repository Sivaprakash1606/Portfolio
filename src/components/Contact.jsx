...
const Contact = () => {
  return (
    <div
      name="contact"
      className="w-full sm:pt-0 pt-64 h-full bg-gradient-to-b from-black to-gray-800 p-4 text-white"
    >
      <div className="flex sm:pt-12 pt-64 flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
